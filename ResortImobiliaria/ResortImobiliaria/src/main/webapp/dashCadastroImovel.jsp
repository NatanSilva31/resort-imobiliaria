      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        ...
        <div class="position-sticky pt-3 sidebar-sticky">
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="./index.html"><span data-feather="home"
                  class="align-text-bottom"></span> Home </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/cadastroImovel"><span data-feather="file-text"
                  class="align-text-bottom"></span> Nova Casa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/HomeLogada"><span data-feather="file-plus"
                  class="align-text-bottom"></span> Todos imoveis</a>
            </li>
            </li>
          </ul>
        </div>
                  ...
                  <td>
                    <form action="/delete-cadastroImovel" method="post">
                      ...
                      <a class="btn btn-outline-success"
                        href="cadastroImovel.jsp?idCadastroImovel=${cadastro.idCadastroImovel}&name=${cadastro.tituloImovel}&endereco=${cadastro.endereco}&numquartos=${cadastro.numQuartos}&numbanheiro=${cadastro.numBanheiro}&numvagas=${cadastro.numVagas}&valornoite=${cadastro.valorNoite}&imagens=${cadastro.imagens}&Email=${cadastro.email}&telefone=${cadastro.telefone}&obs=${cadastro.obs}">Atualizar</a>
                    </form>
                  </td>
            </tr>
            </c:if>
